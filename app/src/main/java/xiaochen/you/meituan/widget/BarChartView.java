...
import xiaochen.you.meituan.util.LogUtil;
import xiaochen.you.meituan.util.Screen;
...
public class BarChartView extends View {
	...
	public void setData(List<Integer> data) {
		...
		aniProgress = new Integer[data.size()];
...
//        cellValue = getCellValue(cellValue);
    ...
    private void drawColumn(Canvas canvas, Paint paint) {
        ...
        //Y轴最大刻度
        float MaxAxisYValue = (float)(maxAxisValueY / axisDivideSizeY)*axisDivideSizeY;
...
//    }
	...
	private Integer[] aniProgress;// 实现动画的值
